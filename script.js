...
function updateHeroTitle(titleIndex) {
    let txt1 = `Los Mejores productos del campo a tu casa`;
    let txt2 = `Suple tus necesidades diarias de una forma facil e instantanea`;
    let txt3 = `Prueba las mejores frutas para un estilo de vida mas sano`;
    let txt4 = `Obten un 50% de descuento en todos los productos`;
    let txt5 = `Buenas ofertas con maravillosos productos`;
    let txt6 = `Vegetales frescos con un gran descuento`;
...
function updatePopularProductInfo(index) {
    ...
    if (getCategory === 'frutas') {
        imgCategory.textContent = `frutas`;
    } else if (getCategory === 'vegetales') {
        imgCategory.textContent = `vegetales`;
    } else if (getCategory === 'huevos') {
        imgCategory.textContent = `huevos`;
    } else if (getCategory === 'ganado') {
        imgCategory.textContent = `ganado`;
    } else if (getCategory === 'carnes') {
        imgCategory.textContent = `carnes`;
    }else if (getCategory === 'grano') {
        imgCategory.textContent = `grano`;
    }
