...
<head>
    ...
    <style>
        ...
        /* Mostrar el menú desplegable cuando se pasa el ratón por encima del botón */
    ...
    <header>
        <nav class="navbar">
            ...
            <!--<div class="search-box">
                ...
                <input type="text" placeholder="Search...">hola
            ...
            <div class="icon-links">
                <!--<div id="search-btn"><span class="i con-search"></span></div>-->
                ...
                <div id=""><span class="icon-user"></div>
...
<div class="dropdown">
    <button class="dropdown-btn"><?php echo $_SESSION['usuario']; ?></button>
    <div class="dropdown-content">
        <a href="perfil.php">PERFIL</a>
        <a href="cerrarseion.php">CERRAR SESION</a>
    </div>
</div>
...
s
            ...
            <div class="section-wrap hero-wrap">
                ...
                <div class="hero-description">
                    <h1 class="animate__animated animate__bounceInRight hero-title">Los Mejores frutos secos para que tu familia se alimente sanamente</h1>
                ...
                <div class="new-arrivals-products">
                    <div class="new-arrival-card">
                        ...
                        <div class="new-arrival-card-text">
                           ...
                           <button>Ver las categorias</button> 
                        </div>
                    </div>
        ...
        <div class="about" id="about">
            <div class="section-wrap about-wrap">
                ...
                <div class="about-description">
                    ...
                    <p>Atque molestias illo consectetur odio laborum libero consectetur accusamus reiciendis molestias laboriosam omnis dolor cupiditate fugit iusto perferendis praesentium eos excepturi magnam corporis earum magnam est cumque commodi voluptate
                        distinctio perspiciatis aperiam rerum quae soluta quam incidunt quis beatae corrupti eaque.</p>
                    <p>Dacilis in corporis ad itaque minus necessitatibus laudantium quod inventore sint repellat nam lorem ipsum dolor sit amet consectetur adipisicing elit atque molestias illo consectetur odio laborum libero doloremque. </p>
                    <p>Stque molestias illo consectetur odio laborum libero doloremque lorem ipsum dolor sit amet consectetur adipisicing elit doloremque facilis atque.</p>
                    <marquee behavior="scroll" scrollamount="10" direction="left" class="about-marquee">
                        Welcome to eBazar! Get your daily needs easy and instant from our shop. Buy fresh and organic fruits with a big discount! Please use this voucher code (#234307) to get upto 50% discunt from your total purchase. Dear sir, Now you can get upto 50% discount
                        of any product just using this voucher code (#234307). Don't forget to submit this code at the checkout time of your purchase. Thank You!
                    </marquee>
                ...
                <div class="services-description">
                    <div class="service-description-text">
                        ...
                        <div class="service-description-details">
                            <p>Adipisicing elit praesentium laudantium saepe explicabo alias odit debitis provident cumque reiciendis earum quibusdam illo sit pariatur unde aperiam totam quisquam illum facilis deleniti quae doloremque natus corrupti quidem
                                architecto quam molestiae neque cupiditate sapiente quo assumenda quia ratione ducimus excepturi iure aliquam labore.
                            </p>
                        </div>
                        ...
                        <div class="service-description-list">
                            ...
                            <div class="service-description-list-item">
                                <span class="icon-check-circle"></span>
                                <p class="service-list-item-title">Consectetur adipisicing elit molestiae fugiat perferendis.
                                </p>
                            </div>

                            <div class="service-description-list-item">
                                <span class="icon-check-circle"></span>
                                <p class="service-list-item-title">Dapiente ipsa omnisode temporibus accusamus obcaecate.
                                </p>
                            </div>

                            <div class="service-description-list-item">
                                <span class="icon-check-circle"></span>
                                <p class="service-list-item-title">Minima quia nobis sint suscipit harum assumenda error.
                                </p>
                            </div>
                        </div>
                ...
                <div class="service-card-wrap">
                    <div class="service-image-wrap">
                        ...
                        <div class="service-image-text">
                            <h1>Our Services</h1>
                            <p>Lorem ipsum dolor sit amet consectetur libero neque officia eum quaerat sapiente est debitis
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="service-cards">
                        <div class="service-card">
                            ...
                            <div class="service-card-details">
                                ...
                                <p>Qutem optio alias ducimus dignissimos consequuntur unde iure illum sapiente explicabo dolore pariatur eligendi fuga asperiores lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                ...
                <div class="faq-content">
                    ...
                    <div class="faq-content-wrap">
                        <div class="accordion-box">
                            ...
                            <p class="faq-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione dolor aliquam tempora excepturi quo voluptas aperiam omnis illum. Illo laudantium aliquam accusantium tenetur corporis cumque quos eaque quam voluptatibus dignissimos
                                vitae blanditiis officiis animi incidunt explicabo placeat quisquam necessitatibus architecto.
                            </p>
                        </div>
                        ...
                        <div class="accordion-box">
                            <p class="faq-title">03. Why our services best? <span class="icon-angle-right faq-icon"></span>
                            </p>
                            <p class="faq-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione dolor aliquam tempora excepturi quo voluptas aperiam omnis illum. Illo laudantium aliquam accusantium tenetur corporis cumque quos eaque quam voluptatibus dignissimos
                                vitae blanditiis officiis animi incidunt explicabo placeat quisquam necessitatibus architecto.
                            </p>
                        ...
                        <div class="accordion-box">
                            <p class="faq-title">04. How we manage our services? <span class="icon-angle-right faq-icon"></span></p>
                            <p class="faq-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione dolor aliquam tempora excepturi quo voluptas aperiam omnis illum. Illo laudantium aliquam accusantium tenetur corporis cumque quos eaque quam voluptatibus dignissimos
                                vitae blanditiis officiis animi incidunt explicabo placeat quisquam necessitatibus architecto.
                            </p>
                        </div>
                        ...
                        <div class="accordion-box">
                            <p class="faq-title">05. How we atchieve our customer satisfaction? <span class="icon-angle-right faq-icon"></span></p>
                            <p class="faq-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione dolor aliquam tempora excepturi quo voluptas aperiam omnis illum. Illo laudantium aliquam accusantium tenetur corporis cumque quos eaque quam voluptatibus dignissimos
                                vitae blanditiis officiis animi incidunt explicabo placeat quisquam necessitatibus architecto.
                            </p>
                        </div>
                    ...
                    <div class="review-items">
                        <div class="review-content">
                            ...
                            <div class="review-text">
                                <p class="review"><span class="icon-quote-left"></span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque dolor animi harum tempore. Harum veritatis aspernatur eos laudantium at iste repellendus quaerat molestias ete earum quam
                                    deleniti hic dolor architecto fuga tenetur ducimus eius ipsam Adipisci magnam sit.<span class="icon-quote-right"></span></p>
                            </div>
                        </div>
                    ...
                    <div class="contact-area">
                        <div class="contact-info">
                            ...
                            <div class="contact-address">
                                ...
                                <p>North Tower, 5th Floor,<br> 2125 Hudson St, NY 2577</p>
                            </div>
       ...
       <!--  <div class="subscribe-popup animate__animated animate__bounceInUp">
        ...
        <!-- gg                                     yyu65   u   and signup form start -->
        <div class="login-and-signup-wrap">
            ...
            <div class="login-wrap">
                <div class="ls-from-title">
                  ...
                  <form action="validar2.php" method="post">
                    <div class="ls-input-area">
                        <input type="email" id="email" name="usuario" autocomplete="off" required>
                        <label for="email">Email</label>
                    </div>
                    ...
                    <div class="ls-button-area">
                        <button type="submit" class="login-btn"> Ingresa </button>
                    </div>
                </form>
                ...
                <div class="form-toggle-area">
                    <p> No eres miembro? <span id="toggle-signup">Registrate Ahora</span></p>
                </div>
            </div>
            ...
            <div class="signup-wrap">
                ...
                <div class="form-toggle-area">
                    <p> Ya eres miembro? <span id="toggle-login"> Ingresa ahora </span></p>
                </div>
            </div>
        </div>
        </form>
        ...
        <div id="footer">
                ...
                <div class="section-wrap">
                    <div class="subscribe-wrap">
                        <div class="subscribe-text">
                            <p>Suscribete para ser el primero en enterarte de nuestras promociones</p>
                        </div>

                        <form class="subscribe-input">
                            <input type="email" placeholder="Ingresa tu gmail" required>
            ...
            <footer>
                <p>Created By | &copy; 2021 All rights reserved</p>
            </footer>
            <!-- copyright area end -->
