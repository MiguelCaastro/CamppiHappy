...
if (isset ($_POST['buscador'])) {
    ...
    if (empty($buscar)) {
        ...
        $consulta = "SELECT * FROM user WHERE usuario LIKE '%".$buscar. "%'";
           ...
           <?php
             ...
             ?>       
               <div class="datos" >
                <br>
                    <tr>Id 
                        <td><?php echo $row ['id_usuario']; ?> <td></tr>
                    <br>
                        <tr>Nombre 
                        <td><?php echo $row ['nombre']; ?> <td></tr>
                        <br>
                        <tr>Usuario 
                        <td><?php echo $row ['usuario']; ?> <td></tr>
                        <br>
                        <tr>Contraseña 
                        <td><?php echo $row ['pass']; ?> <td></tr>
                        <br>
                        <tr>Tipo 
                        <td><?php echo $row ['tipo']; ?> <td></tr>
                        <br>
                        <tr>Correo 
